...
public class API {
    ...
    public static String loginUser(String email, String password) throws IOException {
        ...
        try{
            String requestBody = "{\"email\":\"" + email + "\",\"password\":\"" + password + "\"}";
            return extractToken(sendPostJWT(apiUrl,requestBody,"NONE.JWT.TOKEN"));
        }
        catch (Exception e){
    ...
    public static String likeMusic(int songID,String jwt) throws IOException {
    ...
    public static String unlikeMusic(int songID,String jwt) throws IOException {
